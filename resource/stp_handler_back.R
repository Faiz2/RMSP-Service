...
##-- handle the exception thrown out
  ...
  if (phase==1){
    ...
    "p1_report2_mod3" = data_to_use2$report2_mod3,
    "p1_report2_mod4" = data_to_use2$report2_mod4,
    "p1_report2_mod5" = data_to_use2$report2_mod5,
    "p1_report3_mod1" = data_to_use2$report3_mod1,
    "p1_report3_mod2" = data_to_use2$report3_mod2,
    "p1_report4_mod1" = data_to_use2$report4_mod1,
    "p1_report5_mod1" = data_to_use2$report5_mod1,
    ...
    "p2_report2_mod1" = data_to_use2$report2_mod1,
    "p2_report2_mod2" = data_to_use2$report2_mod2,
    "p2_report2_mod3" = data_to_use2$report2_mod3,
    "p2_report2_mod4" = data_to_use2$report2_mod4,
    "p2_report2_mod5" = data_to_use2$report2_mod5,
    "p2_report3_mod1" = data_to_use2$report3_mod1,
    "p2_report3_mod2" = data_to_use2$report3_mod2,
    "p2_report4_mod1" = data_to_use2$report4_mod1,
    "p2_report5_mod1" = data_to_use2$report5_mod1,
    "p2_report5_mod2" = data_to_use2$report5_mod2,
    "p2_report5_mod3" = data_to_use2$report5_mod3)
   }
